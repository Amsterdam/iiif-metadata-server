...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('ab_1234', 'AB', '1234'),  # with underscore and lowercase letter stadsdeelcode formatting
        ('ab_1234', 'AB', '1234'),  # with underscore and lowercase letter stadsdeelcode formatting
        ...
        ('abcd_1234', 'ABCD', '1234'),  # with underscore and lowercase letter stadsdeelcode formatting
        ('abcd_1234', 'ABCD', '1234'),  # with underscore and lowercase letter stadsdeelcode formatting
    ]
)
